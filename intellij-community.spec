...
# Copy modules if they exist (sometimes in lib or separate)
if [ -d modules ]; then cp -arf ./modules %{buildroot}%{_javadir}/%{name}/; fi

# Installing icons...
install -d %{buildroot}%{_datadir}/pixmaps
# IntelliJ icons usually in bin/idea.png or idea.svg
...
- Initial IntelliJ IDEA Community Edition package based on PyCharm spec
